classdef unscented_transform_augment_state < handle
    % Unscented transform with augment stater class for uncertinty propagation 
    % through a nonlinear model. For the algorithm, see State Estimation for Robotics, 
    % Hui Sun .
    %
    %   
    ...
    properties
        ...
        Cov_control;    % covariance for control
        Cov_measurement % covariance for measurement 
    ...
    methods
        function obj = unscented_transform(mean_state, cov_mean...
                ,cov_control, cov_measurement, f, kappa)
            ...
            if nargin == 0
                ...
                obj.kappa = [];
            elseif nargin == 4
                obj.x_input = mean_state;
                obj.P = cov;
                obj.func = f;
                obj.n = numel(mean_state)+length(cov_control)...
                    +length(cov_measurement);
                obj.kappa = kappa;
            else
